...
# Form implementation generated from reading ui file '/home/wasuaje/Documentos/desarrollo/nomina/ui/banco_cuenta.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 0, 401, 371))
        ...
        self.lineEdit.setGeometry(QtCore.QRect(70, 50, 311, 27))
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.label = QtGui.QLabel(self.tab)
        self.label.setGeometry(QtCore.QRect(10, 50, 51, 17))
        self.label.setObjectName(_fromUtf8("label"))
        self.tableView = QtGui.QTableView(self.tab)
        self.tableView.setGeometry(QtCore.QRect(10, 90, 371, 191))
        self.tableView.setObjectName(_fromUtf8("tableView"))
        self.comboBox = QtGui.QComboBox(self.tab)
        self.comboBox.setGeometry(QtCore.QRect(70, 10, 311, 27))
        self.comboBox.setObjectName(_fromUtf8("comboBox"))
        self.label_2 = QtGui.QLabel(self.tab)
        self.label_2.setGeometry(QtCore.QRect(10, 10, 51, 17))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtGui.QApplication.translate("MainWindow", "Cuentas Bancarias", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("MainWindow", "Cuenta:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("MainWindow", "Banco:", None, QtGui.QApplication.UnicodeUTF8))
