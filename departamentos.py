...
from ui.Ui_departamentos import Ui_MainWindow
...
class Departamentos(QMainWindow, Ui_MainWindow):
	"""
	...
	def __init__(self, parent = None):
		...
		self.search.tabla='cf_departamento'		
	...
	def fill_data(self, id=None):				
		...
		if self.datos.check_havedata('cf_departamento')==True	:
			...
			self.emp = self.datos.get_data('cf_departamento', id)		
	...
	def on_actionGuardar_triggered(self):
		...
		if self.isadding:
			...
			self.lastid=self.datos.save_departamento(datos)
			self.mensaje='Datos salvados con exito'			
		elif self.isediting:
			datos=[self.lineEdit.text(), self.empid]
			self.datos.update_departamento(datos)
